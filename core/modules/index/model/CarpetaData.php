...
class CarpetaData {
	...
	// }
	public function registro_nueva_carpeta(){
		$sql = "insert into ".self::$tablename." (nombre,descripcion,usuario_id,fecha) ";
		$sql .= "value (\"$this->nombre\",\"$this->descripcion\",$this->usuario_id,NOW())";
	...
	public function Actualizacion_Carpeta(){
		$sql = "update ".self::$tablename." set nombre=\"$this->nombre\",descripcion=\"$this->descripcion\",usuario_id=\"$this->usuario_id\" where id_carpeta=$this->id_carpeta";
		Executor::doit($sql);
	}
