...
<div class="content-wrapper">
    <section class="content-header">
      <h1> <i class="fa fa-user-circle"></i> 
        Lista de los Usuarios<small> </small>
      </h1>
      <!-- <ol class="breadcrumb">
        ...
        <div class="box-header with-border">
          ...
          <small>
            <div class="box-tools pull-left">
             <?php if ($u->admin):?><a href="#myModal" data-toggle="modal" class="btn btn-primary btn-sm btn-flat"><i class="fa fa-user-plus"></i> Nuevo Usuario</a>
            ...
            <div class="modal-body has-feedback has-warning">
              <form class="form-horizontal" method="POST" action="index.php?action=nuevoadministrador">
                <div class="form-group has-feedback has-warning">
                    ...
                    <div class="col-sm-9">
                      <input type="text" class="form-control" id="nombre" name="nombre" required onkeypress="return sololetras(event)" onpaste="return false" onKeyUP="this.value=this.value.toUpperCase();">
